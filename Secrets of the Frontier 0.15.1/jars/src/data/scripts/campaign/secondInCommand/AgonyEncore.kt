...
class AgonyEncore : SCBaseSkillPlugin() {
    ...
    override fun addTooltip(data: SCData, tooltip: TooltipMakerAPI) {
        ...
        tooltip.addPara("Landing the final blow on an opposing ship provides a temporary increase in timeflow", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("   - Upon triggering, the ship's timeflow is doubled for 5/7/8/10 seconds, based on the target's hull size",
