...
class SotfChildOfTheLakeCampaignVFX : LunaCampaignRenderingPlugin {
    ...
    @Transient
    var noise1: SpriteAPI? = Global.getSettings().getSprite("graphics/fx/sotf_child_of_the_lake_noise1.png")
    ...
    override fun render(layer: CampaignEngineLayers?, viewport: ViewportAPI?) {
        ...
        if (shader == null || shader == 0) {
            shader = ShaderLib.loadShader(
                ...
                Global.getSettings().loadText("data/shaders/sotf_child_of_the_lake.shader"))
            if (shader != 0) {
