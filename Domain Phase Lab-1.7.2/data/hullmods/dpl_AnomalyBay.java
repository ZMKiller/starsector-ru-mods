...
public class dpl_AnomalyBay extends BaseHullMod {
	public static float REPLACEMENT_TIME_MULT = 0.8f;
	public static float SMOD_CRUISER = 20f;
	public static float SMOD_CAPITAL = 30f;
	
	public String getDescriptionParam(int index, HullSize hullSize) {
		if (index == 0) return "" + (int) Math.round((1f-REPLACEMENT_TIME_MULT) * 100) + "%";
		return null;
	}
	...
	public void applyEffectsBeforeShipCreation(HullSize hullSize, MutableShipStatsAPI stats, String id) {
		...
		stats.removeListenerOfClass(data.hullmods.dpl_AnomalyBay.dpl_AnomalyBayListener.class);
		stats.addListener(new data.hullmods.dpl_AnomalyBay.dpl_AnomalyBayListener());
   }
	...
	public class dpl_AnomalyBayListener implements FighterOPCostModifier {
