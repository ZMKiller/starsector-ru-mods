 ...
 */
public class dpl_song_of_creationEffect extends BaseCombatLayeredRenderingPlugin implements OnFireEffectPlugin {

    public dpl_song_of_creationEffect() {
    }
    ...
    public void onFire(DamagingProjectileAPI projectile, WeaponAPI weapon, CombatEngineAPI engine) {
        ...
        dpl_song_of_creationEffect effect = new dpl_song_of_creationEffect(projectile);
    ...
    public dpl_song_of_creationEffect(DamagingProjectileAPI proj) {
        this.proj = proj;
    ...
    public void render(CombatEngineLayers layer, ViewportAPI viewport) {
        ...
        for (ParticleData p : particles) {
            ...
            float frameFloat = remainder / 0.1f;
            ...
            if (p.isEarlyFrame) {
                ...
                float factor_EF = (float) ((Math.cos(Math.PI*subFrame)+1)/2);
            ...
            //Second frame
                ...
                float factor_LF = (float) ((Math.cos(Math.PI*(1f-subFrame))+1)/2);
