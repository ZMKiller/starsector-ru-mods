 ...
 */
public class dpl_crotchetsEffect implements OnHitEffectPlugin, OnFireEffectPlugin {
	...
	public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target,
		...
		if (target instanceof ShipAPI) {
			...
			if (!ship.isFighter() && !ship.isDrone()) {
				...
				if (shieldHit) {
					float shieldDam = projectile.getDamageAmount();
					ship.getFluxTracker().increaseFlux(shieldDam, true);
				}
