...
public class dpl_TransplutonicThirst extends HubMissionWithBarEvent implements FleetEventListener {

    // mission stages
    public static enum Stage {
        COLLECT_TRANSPLUTONICS,
        COMPLETED,
        FAILED,
    }
    ...
    protected boolean create(MarketAPI createdAt, boolean barEvent) {
        ...
        setStartingStage(Stage.COLLECT_TRANSPLUTONICS);
        ...
        makeImportant(market, "$dpl_trth", Stage.COLLECT_TRANSPLUTONICS);
		makeImportant(person, "$dpl_trth", Stage.COLLECT_TRANSPLUTONICS);
    ...
    public void addDescriptionForNonEndStage(TooltipMakerAPI info, float width, float height) {
        ...
        if (currentStage == Stage.COLLECT_TRANSPLUTONICS) {
